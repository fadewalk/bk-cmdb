...
const scripts = [
  ...
  'run-b49-set-template-crud.cjs', 'run-b51-host-apply-contract.cjs', 'run-b52-service-template-parity.cjs', 'run-b53-service-template-detail.cjs', 'run-b54-service-template-details.cjs', 'run-b55-service-template-clone.cjs',
