...
const scripts = [
  ...
  'run-b24.cjs', 'run-b25.cjs', 'run-b26.cjs', 'run-b27.cjs', 'run-b28.cjs', 'run-b29.cjs', 'run-b30.cjs', 'run-b31.cjs', 'run-b32.cjs', 'run-b33.cjs', 'run-b34.cjs', 'run-b35.cjs', 'run-field-template.cjs', 'run-m1-model-management.cjs', 'run-m2-model-topology-mock.cjs', 'run-m2-association-type-mock.cjs', 'run-m2-instance-association-mock.cjs', 'run-m2-model-detail-association-mock.cjs',
...
function testKind(script) {
  if (/m1-model-management|m2-model-topology|m2-association-type|m2-instance-association|m2-model-detail-association|core-domains-errors|core-domains-mock|iam/.test(script)) return 'mock-contract'
