  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'business/service-category', name: 'ServiceCategory', component: () => import('../views/service/ServiceTemplate.vue'), meta: { title: '服务分类', tab: 'category' } },
        ...
        { path: 'business/custom-fields', name: 'CustomFields', component: ComingSoon, meta: { title: '自定义字段' } },
        ...
        // 平台管理
        { path: 'platform/global-config', name: 'GlobalConfig', component: ComingSoon, meta: { title: '全局配置' } },
