  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'business/:bizId/service/template/details/:templateId', name: 'SvcTplDetails', component: () => import('../views/service/ServiceTemplateDetails.vue'), meta: { title: '服务模板' } },
        ...
        { path: 'model/index/details/:modelId', name: 'ModelDetailLegacy', redirect: (to) => ({ path: `/model/management/details/${to.params.modelId}`, query: to.query }), meta: { title: '模型详情' } },
        ...
        { path: 'model/all/topology/new', name: 'ModelTopologyLegacy', redirect: (to) => ({ path: '/model/topology', query: to.query }), meta: { title: '模型拓扑' } },
        ...
        { path: 'model/field-template/edit/:id/binding', name: 'FieldTemplateEditBinding', component: () => import('../views/model/FieldTemplateBind.vue'), meta: { title: '编辑字段组合模板' } },
        { path: 'model/field-template/bind/:id', name: 'FieldTemplateBindLegacy', component: () => import('../views/model/FieldTemplateBind.vue'), meta: { title: '绑定模型' } },
        { path: 'model/field-template/sync/:id/model/:modelId', name: 'FieldTemplateSyncLegacy', component: () => import('../views/model/FieldTemplateSync.vue'), meta: { title: '同步模型' } },
